...
#define echoPin 8 //Pino 8 recebe o pulso do echo
...
void setup()
{
   ...
   pinMode(trigPin, OUTPUT); // define o pino 13 como saida (envia)
}

void loop()
{
    lcd.setCursor(0, 1);// Colocando o cursor na coluna 0 e linha 1
  //seta o pino 13 com um pulso baixo "LOW" ou desligado ou ainda 0
    digitalWrite(trigPin, LOW);
  // delay de 2 microssegundos
    delayMicroseconds(2);
  //seta o pino 13 com pulso alto "HIGH" ou ligado ou ainda 1
    digitalWrite(trigPin, HIGH);
  //delay de 10 microssegundos
    delayMicroseconds(10);
  //seta o pino 13 com pulso baixo novamente
    digitalWrite(trigPin, LOW);
